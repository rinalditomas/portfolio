      ...
      <Fade>
        ...
        <div className="grid">
          ...
          <div className="item1">
            ...
            <p className="paragraph">
              CRUCE is a full stack application where companies can handle their
              products' deliveries in realtime, register delivery
              companies/riders and check all their metrics
            </p>
            <div className="tech-box">
              <p className="technologies">Javascript</p>
              <p className="technologies">React</p>
            ...
            <a className="link" href="https://github.com/rinalditomas/Cruce">
              Check the code
            </a>
          </div>
          <div className="item2">
            ...
            <p className="paragraph">
              Argentine products sales page focusing on a foreign audience
            </p>
            <div className="tech-box">
              <p className="technologies">Javascript</p>
              <p className="technologies">React</p>
            ...
            <a className="link" href="https://github.com/rinalditomas/argentum">
              Check the code
            </a>
          </div>
          ...
          <div className="item3">
            ...
            <p className="paragraph">
              A IMDB clone, it was developed using a rest API
            </p>
            <div className="tech-box">
              <p className="technologies">Javascript</p>
              <p className="technologies">React</p>
            ...
            <a
              className="link"
              href="https://github.com/rinalditomas/ImdbClone"
            >
              Check the code
            </a>
          </div>
          ...
          <div className="item3">
            ...
            <p className="paragraph">
              Shopping list application where you can add/file/delete shopping
              lists and edit their items once you access them only if they are
              not archived
            </p>
            <div className="tech-box">
              <p className="technologies">Javascript</p>
            ...
            <a
              className="link"
              href="https://github.com/rinalditomas/ShoppingList-App"
            >
              Check the code
            </a>
          </div>
          <div className="item3">
            ...
            <p className="paragraph">
              Personal porfolio to showcase all my projects
            </p>
            <div className="tech-box">
              <p className="technologies">Javascript</p>
              <p className="technologies">React</p>
            ...
            <a
              className="link"
              href="https://github.com/rinalditomas/portfolio"
            >
              Check the code
            </a>
          </div>
